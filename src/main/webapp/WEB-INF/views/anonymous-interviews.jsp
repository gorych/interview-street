    ...
    <div class="row">
        <div class="box box-padding-fix ">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <div class="preview">Здравствуйте, аноним.<br/> Потратьте, пожалуйста, несколько минут своего
                        времени на заполнение следующей анкеты. Мы гарантируем кофеденциальность введенной Вами информации
                    </div>
                </c:otherwise>
            </c:choose>
        </div>
