...
<script id="disabled-answer-tmpl" type="text/x-jsrender">
     <div data-answer="{{:id}}" class="row narrow-row">
        <div class="input-field col offset-l2 l7 m11 s11">
            <input disabled type="text" length="100" value="{{:text}}" title="Текст ответа"/>
            <label class="active">Не содержит ответа</label>
        </div>
